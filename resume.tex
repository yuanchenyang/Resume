...
\begin{body}
  ...
  \emph{The University of Berkeley at California}, Berkeley, CA{} \hfill GPA: 3.967 (Technical: 4.00)\\
\end{body}
...
\begin{body}
  \vspace{14pt}
  \textbf{Proficient in} Python, Javascript, Emacs, HTML, jQuery, Java, \LaTeX \\
  \textbf{Experience in} C, Scheme, Haskell, SQL, Android, Assembly
\end{body}
...
\begin{body}
  ...
  \textbf{Facebook Group Archiver} \hfill \url{https://github.com/yuanchenyang/facebook-group-archiver}\\
