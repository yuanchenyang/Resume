...
\begin{body}
  \vspace{14pt}
  \textbf{Research Scientist}, \emph{Toyota Research Institute}, Cambridge, MA \hfill  2022--Present\\
  \vspace*{-5pt}
  \begin{itemize} \itemsep -0pt  % reduce space between items
  \item Explore optimization-based interpretations of diffusion models to
    improve fundamental understanding of how these models work
  \item Integrate numerical constraints into diffusion models, with applications
    to vehicle engineering design
  \item Develop and deploy optimization algorithms for planning and assignment
    tasks to improve factory logistics efficiency
  \item Publish basic research and/or file patents related to above topics
  \end{itemize}
\end{body}
...
\begin{body}
  ...
  Thesis: \emph{Polynomial Structure in Semidefinite Relaxations and Non-Convex Formulations} \\

  \vspace{5pt}
  \textbf{SM in Electrical Engineering and Computer Science } \hfill  2016 -- 2018 \\
  \emph{Massachusetts Institute of Technology}, Cambridge, MA{} \hfill GPA: 5/5 \\
  Thesis: \emph{Focused Polynomials, Random Projections and Approximation Algorithms
...
\begin{body}
  \vspace{14pt}
  Artem Lukoianov, \textbf{Chenyang Yuan}, Justin Solomon, Vincent Sitzmann (2025). Locality in Image Diffusion Models Emerges from Data Statistics. \emph{Neural Information Processing Systems \textbf{(NeurIPS Spotlight)}} \\

  \smallskip

  Abulikemu Abuduweili, \textbf{Chenyang Yuan}, Changliu Liu, Frank Permenter (2025). Enhancing Sample Generation of Diffusion Models using Noise Level Correction. \emph{Transactions on Machine Learning Research (TMLR)} \\

  \smallskip

  Jie Yun, \textbf{Chenyang Yuan}, Katherine Irelan, MJ Kabongo, Eldar Urkumbayev, David L. Des Marais (2025). A Machine Learning Enabled Approach to Assess Trade-offs between Growth and Stress Tolerance in Pooideae Grasses Following Domestication. \emph{Journal Of Experimental Botany (JXB)} \\

  \smallskip

  Rui Zhou, Yanxia Zhang, \textbf{Chenyang Yuan}, Frank Permenter, Nikos Arechiga, Matt Klenk, Faez Ahmed (2025). Parametric-ControlNet: Multimodal Control in Foundation Models for Precise Engineering Design Synthesis. \emph{Journal of Mechanical Design (JMD)} \\

  \smallskip

  Hayata Morita, Kohei Shintani, \textbf{Chenyang Yuan}, Frank Permenter (2025). WheelSDF: Implicit Representation-Based 3D Shape Generation and Interpolation for Wheel Design. \emph{International Design Engineering Technical Conferences (IDETC)} \\

  \smallskip

  Binyang Song, \textbf{Chenyang Yuan}, Frank Permenter, Nikos Arechiga and Faez Ahmed (2024). Data-Driven Car Drag Prediction with Depth and Normal Renderings. \emph{Journal of Mechanical Design (JMD)} \\

  \smallskip

  Frank Permenter*, \textbf{Chenyang Yuan}* (2024). Interpreting and Improving Diffusion Models from an Optimization Perspective. \emph{International Conference on Machine Learning (ICML)} \\

  \smallskip

  Rui Zhou, \textbf{Chenyang Yuan}, Frank Permenter, Yanxia Zhang, Nikos Arechiga, Matt Klenk, Faez Ahmed (2024). Bridging Design Gaps: A Parametric Data Completion Approach With Graph-Guided Diffusion Models. \emph{International Design Engineering Technical Conferences (IDETC)} \\

  \smallskip

  Yan-Ying Chen, Nikos Arechiga, \textbf{Chenyang Yuan}, Matthew Hong, Matt Klenk, Charlene Wu (2024). Stylish and Functional: Guided Interpolation Subject to Physical Constraints. \emph{NeurIPS Workshop on Foundation Models for Science (FM4Science)} \\

  \smallskip

  Hayata Morita, Kohei Shintani, \textbf{Chenyang Yuan}, Frank Permenter (2024). VehicleSDF: A 3D generative model for constrained engineering design via surrogate modeling. \emph{NeurIPS Workshop on Data-driven and Differentiable Simulations, Surrogates, and Solvers (D3S3)} \\

  \smallskip

  Binyang Song, \textbf{Chenyang Yuan}, Frank Permenter, Nikos Arechiga and Faez Ahmed (2023). Surrogate Modeling of Car Drag Coefficient with Depth and Normal Renderings. \emph{International Design Engineering Technical Conferences (IDETC)} \\

  \smallskip

  Beno\^it Legat*, \textbf{Chenyang Yuan}* and Pablo Parrilo (2023). Low-Rank Univariate Sum of Squares Has No Spurious Local Minima. \emph{SIAM Journal on Optimization (SIOPT)} \\

  \smallskip

  Nikos Arechiga*, Frank Permenter*, Binyang Song* and \textbf{Chenyang Yuan}* (2023). Drag-Guided Diffusion Models for Vehicle Image Generation. \emph{NeurIPS Workshop on Diffusion Models} \\

  \smallskip

  \textbf{Chenyang Yuan} and Pablo Parrilo (2022). Maximizing Products of Linear Forms, and the Permanent of Positive Semidefinite Matrices. \emph{Mathematical Programming Series A (MAPR)} \\

  \smallskip

  J. Thai, \textbf{C. Yuan}, A. Bayen (2016). Resiliency of Mobility-as-a-Service Systems to Denial-of-Service Attacks. \emph{IEEE Transactions on Control of Network Systems (TCNS)} \\

  \smallskip

  \textbf{C. Yuan}*, J. Thai*, A. Bayen (2016). ZUbers against ZLyfts Apocalypse: An Analysis Framework for DoS Attacks on Mobility-as-a-Service Systems. \emph{International Conference on Cyber-Physical Systems (ICCPS)} \\

  \smallskip

  MV Reddy, HY Cheng, JH Tham, \textbf{CY Yuan}, HL Goh, BVR Chowdari (2012). Preparation of Li(Ni0.5Mn1.5)O4 by polymer precursor method and its electrochemical properties. \emph{Electrochimica Acta}

  \smallskip
  \tiny{(* denotes equal contribution / alphabetical ordering)}
\end{body}
\smallskip
...
\begin{body}
  ...
  Products of
  Nonnegative Forms on the Sphere, \emph{Preprint, arxiv:2102.13220}\\
  \smallskip
\end{body}
...
\begin{body}
  \vspace{14pt}
  \textbf{smalldiffusion} \hfill \url{https://github.com/yuanchenyang/smalldiffusion} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% This one is already included in "education"
% \header{Thesis}
% \begin{body}
%   \vspace{14pt}
%   Polynomial Structure in Semidefinite Relaxations and Non-Convex Formulations,
%   \emph{PhD Thesis, MIT, 2022} \\
%   \smallskip
%   Focused Polynomials, Random Projections and Approximation Algorithms for
%   Polynomial Optimization over the Sphere,
%   \emph{SM Thesis, MIT, 2018}
% \end{body}
% \smallskip
...
\begin{body}
  \vspace{14pt}
  \textbf{ICCOPT} Session on Algebraic Methods in Optimization \hfill{} \emph{Jul 2025}\\
  \textbf{ISMP} Session on Recent Advances in Quadratic and Semidefinite Optimization \hfill{} \emph{Jul 2024}\\

  \textbf{MIT}  LIDS Seminar \hfill{} \emph{Dec 2023}\\

  \textbf{ICCOPT} Session on Algorithms for Large-scale Conic and Polynomial Optimization \hfill{} \emph{Jul 2022}\\
...
\begin{body}
  ...
  \textbf{A Practical Introduction to Diffusion Models (6.S183)}, \emph{MIT}
  \hfill \emph{IAP 2025} \\
  \smallskip

  \textbf{Algebraic Techniques and Semidefinite Programming (6.256)}, \emph{MIT}
  \hfill \emph{Spring 2021} \\
  \smallskip

  \textbf{Linear Algebra and Optimization (6.S084/18.061)}, \emph{MIT} \hfill \emph{Fall 2020/2021} \\
  \smallskip
  ...
  \textbf{Nonlinear Optimization (6.252)}, \emph{MIT} \hfill \emph{Spring 2020}\\
  \smallskip

  \textbf{Efficient Algorithms and Intractable Problems (CS170)}, \emph{UC Berkeley} \hfill \emph{Spring 2016}\\
  \smallskip

  \textbf{Designing Information Devices and Systems (EE16A)}, \emph{UC Berkeley} \hfill \emph{Fall 2015}\\
  \smallskip
  % \vspace*{-4pt}
  % \begin{itemize} \itemsep -0pt  % reduce space between items
...
\textbf{Discrete Mathematics and Probability Theory (CS70)}, \emph{UC Berkeley} \hfill \emph{Spring 2015}\\
  \smallskip

  \textbf{Structure and Interpretation of Computer Programs (CS61A)}, \emph{UC Berkeley} \hfill \emph{Fall 2013 -- Fall 2014}\\
  \smallskip
  %\vspace*{-4pt}
  %\begin{itemize} \itemsep -0pt  % reduce space between items
  ...
  \textbf{Math/Physics Olympiad Trainer}, \emph{NUS High School of Math and Science} \hfill \emph{March-August 2012}\\
  \smallskip
  % \vspace*{-4pt}
  % \begin{itemize} \itemsep -0pt  % reduce space between items
...
\begin{body}
  ...
  Sum of Squares: Theory and Applications (book chapter)
\end{body}
\smallskip
